...
- Hazard HP scales with wave: every enemy's HP goes up by +2 every 10 waves (`baseHP + 2 × floor((wave-1)/10)`), so waves 1-10 are base HP, 11-20 are +2, 21-30 are +4, and so on through wave 99. Small asteroids are exempt from most of this climb — their HP is capped at 8 so they never become a tedious bullet sponge.
